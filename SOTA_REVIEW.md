# SOTA Security Expert Final Review — secret-management v2.0.0
...
- Promptfoo tests only run on `plasmayang/secret-management` (forks excluded)
...
*Project: secret-management | Version: v2.0.0*
